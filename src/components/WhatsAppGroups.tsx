  ...
  return (
    <div className="space-y-8 my-12">
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-primary/30 rounded-xl p-8"
      >
        <div className="flex flex-col items-center text-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 mt-6 bg-primary hover:bg-primary/90 text-white font-semibold py-3 px-6 rounded-lg transition-all transform hover:scale-105"
          >
