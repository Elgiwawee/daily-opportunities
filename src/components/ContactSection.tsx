      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Have questions about opportunities or want to partner with us? We'd love to hear from you!
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">contact@dailyopportunities.com</p>
                </div>
              </div>
            ...
            <div className="pt-6">
              ...
              <div className="flex space-x-4">
                <a href="#" className="h-10 w-10 rounded-full bg-indigo-500 flex items-center justify-center text-white hover:bg-indigo-600 transition-colors">
